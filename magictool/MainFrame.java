...
import magictool.dissim.SerialDiss;
...
import magictool.explore.DyeSwapFrame; //Added 5/30/2007 by Michael Gordon for obvious reasons.
import magictool.explore.ReplaceNamesWithAliasesDialog;
...
import magictool.image.FlagFrame;
...
/* Andrew Martens */
import magictool.image.MetaGridManager;
//import magictool.image.MetaGrid;
//import magictool.image.MetaGridOptionsDialog;
import magictool.image.MetaGriddingFrame;
/* End Andrew Martens */
...
//    private String magicToolVersionNumber = "1.4";
   ...
   /* Andrew Martens */
   private JMenu gridChoice = new JMenu();
   private JMenuItem loadSavedGrid = new JMenuItem();
   private JMenuItem createEditMetagrid = new JMenuItem();
   private JMenuItem createEditGrid = new JMenuItem();
   /* End Andrew Martens */
   
   private JMenuItem flagChoice = new JMenuItem();
   ...
   //next line added 6/26/2007 by Michael Gordon
   private JMenuItem replaceNamesWithAliasesChoice = new JMenuItem();
   public JMenu expSelector = new JMenu();
   ...
   //next line added 5/03/2007 by Michael Gordon
   private JMenuItem dyeSwapDataChoice = new JMenuItem();
   ...
   /**manages the flags for the grids for the images*/
   protected FlagManager flagman;
   /**manages the automatic flags for the grids for the images*/
   protected FlagManager autoflagman;
   /**frame for gridding the images*/
   protected GriddingFrame griddingFrame;
   /**frame for flagging spots*/
   protected FlagFrame flagFrame;
   /**frame for exploring data*/
   protected ExploreFrame exploreframe;
   ...
   protected MetaGriddingFrame metaGriddingFrame;
   
   /* End Andrew Martens */
   
   /**thread for the creation of the SegmentFrame*/
   private static Thread segmentFrameCreationThread;
   ...
   private Image desktopImage; //open images
   ...
   public MainFrame() {
      ...
      segmentFrameCreationThread = new Thread(){
          public void run(){
             autoflagman.checkForGridManagerChanges();
             setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
             
             Opener greenImage = new Opener();
             Opener redImage = new Opener();
             ImagePlus ipGrn = greenImage.openImage(greenPath);
             ...
             sf = new SegmentFrame(imageRed, imageGreen, redPixels, grnPixels, manager, flagman, autoflagman, openProject, mframe); //modified MRG to tell SegmentFrame about flagman.
             jdesktoppane.add(sf);
             ...
             //sf.jSplitPaneVert.setDividerLocation(sf.jSplitPaneVert.getHeight()/2);
             //sf.setCurrentCell();
             
             sf.jSplitPaneVert.setDividerLocation(0.5d);
             //sf.idGreen.zoom(((sf.jSplitPaneVert.getHeight()-sf.jSplitPaneVert.getDividerSize()-(2*sf.redPanel.getHeight()))/2)/sf.cellHeight);
             //sf.idRed.zoom(((sf.jSplitPaneVert.getHeight()-sf.jSplitPaneVert.getDividerSize()-(2*sf.redPanel.getHeight()))/2)/sf.cellHeight);
   ...
   private void jbInit() throws Exception {
      ...
      //sets up the background faded image
      ...
      //this.jdesktoppane.setDragMode(JDesktopPane.OUTLINE_DRAG_MODE);		//MC:7/12/05 - to improve performance	//MC:7/21/05 or not...
      
      //Set the size of the initial window based on the screen size
      //Window is centered by the code in class
      // 7/12/05 removed "-25" from height parameter
      ...
      this.setTitle("MAGIC Tool, version " + MagicToolApp.versionString);
      this.addKeyListener(this);	//added 6-14-2007 by Michael Gordon to implement F1 --> Help window
      ...
      //propChoice.setAccelerator(javax.swing.KeyStroke.getKeyStroke(, java.awt.event.KeyEvent.CTRL_MASK, false));
      ...
      /* Andrew Martens - modify the menus for metagridding */
      
      //the original menu will no longer act as a button, but instead act as a parent to 3 submenus
      ...
      */
      ...
      //3 new submenus below "Addressing/Gridding"
      //loadSavedGrid.setText("Load Saved Grid/Metagrid");
      loadSavedGrid.setText("Load Saved Grid");
      loadSavedGrid.setAccelerator(javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_W, KeyEvent.CTRL_MASK , false));
      createEditMetagrid.setText("Edit Metagrid");
      createEditGrid.setText("Create/Edit Grid");
      createEditGrid.setAccelerator(javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_A, KeyEvent.CTRL_MASK, false));
      flagChoice.setText("Spot Flagging");
      flagChoice.setAccelerator(javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_F, KeyEvent.CTRL_MASK, false));
      flagChoice.setEnabled(false);
      flagChoice.addActionListener(new java.awt.event.ActionListener() {
    	  public void actionPerformed(ActionEvent e) {
    		  flagChoice_actionPerformed(e);
    	  }
      });

      
      loadSavedGrid.addActionListener(new java.awt.event.ActionListener() {
          public void actionPerformed(ActionEvent e) {
             loadSavedGrid_actionPerformed(e);
          }
       });
      
      createEditMetagrid.addActionListener(new java.awt.event.ActionListener() {
          public void actionPerformed(ActionEvent e) {
             createEditMetagrid_actionPerformed(e);
          }
       });
      
      createEditGrid.addActionListener(new java.awt.event.ActionListener() {
          public void actionPerformed(ActionEvent e) {
             createEditGrid_actionPerformed(e);
          }
       });
      ...
      //scramGene.setAccelerator(javax.swing.KeyStroke.getKeyStroke(83, java.awt.event.KeyEvent.CTRL_MASK | java.awt.event.KeyEvent.SHIFT_MASK, false));
      ...
      //scramColumn.setAccelerator(javax.swing.KeyStroke.getKeyStroke(83, java.awt.event.KeyEvent.CTRL_MASK | java.awt.event.KeyEvent.SHIFT_MASK, false));
      ...
      //scramBoth.setAccelerator(javax.swing.KeyStroke.getKeyStroke(83, java.awt.event.KeyEvent.CTRL_MASK | java.awt.event.KeyEvent.SHIFT_MASK, false));
      ...
      //avgExpFileChoice.setAccelerator(javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_A, java.awt.event.KeyEvent.CTRL_MASK, false));
      ...
      replaceNamesWithAliasesChoice.setEnabled(false);
      replaceNamesWithAliasesChoice.setText("Replace Names With Aliases...");
      replaceNamesWithAliasesChoice.addActionListener(new java.awt.event.ActionListener() {
    	  public void actionPerformed(ActionEvent e) {
    		  replaceNamesWithAliasesChoice_actionPerformed(e);
    	  }
      });
      ...
      //XXX clusterExportChoice();
      clusterExportChoice.setText("Create Dendrogram with JTreeView");
      //clusterExportChoice.setEnabled(false);
      ...
      //clustDisplayChoice.setAccelerator(javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_D, java.awt.event.KeyEvent.CTRL_MASK, false));
      ...
      limitDataChoice.setText("Reorder / Delete Columns");
      ...
      /*Begin Added 5/30/2007 by Michael Gordon*/
      dyeSwapDataChoice.setText("Dye Swap Data Manipulation");
      dyeSwapDataChoice.setAccelerator(javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_D, KeyEvent.CTRL_MASK | KeyEvent.SHIFT_MASK, false));
      dyeSwapDataChoice.addActionListener(new java.awt.event.ActionListener() {
    	  public void actionPerformed(ActionEvent e) {
    		  dyeSwapDataChoice_actionPerformed(e);
    	  }
      });
      /*End Added 5/30/2007 by Michael Gordon*/
      ...
      /* Andrew Martens */
      //add the 3 submenus to the super menu
      gridChoice.add(loadSavedGrid);
      //gridChoice.add(createEditMetagrid);
      gridChoice.add(createEditGrid);
      
      /* End Andrew Martens */
      gridChoice.add(flagChoice); //MRG 1-10-2007 <-- Andrew, check this
      ...
      manipChoice.add(dyeSwapDataChoice);
      //scramChoice.add(scramOrder);
      ...
      expMenu.add(replaceNamesWithAliasesChoice);
      ...
      this.getContentPane().add(jdesktoppane, null); //adds the desktoppane
      
      manager = new GridManager();
      flagman = new FlagManager(manager);	//MRG 1-10-2007
      autoflagman = new FlagManager(manager);
      metaManager = new MetaGridManager();
   ...
   //opens a new explorer frame for the open expression file
   private void exploreChoice_actionPerformed(ActionEvent e) {
      
      exploreframe = new ExploreFrame(expMain, openProject, this, this);
   ...
   /**
    * gets the JDesktopPane for MainFrame
    * @return JDesktopPane for MainFrame
    */
   public JDesktopPane getJDesktopPane() {
	   return jdesktoppane;
   }
   
   public void loadExpFile(String filename) {
	   //first, make shortfile the shortname
	   String shortfile = new String(filename);
	   if(!shortfile.toLowerCase().endsWith(".exp")) shortfile = shortfile + ".exp";
	   if(shortfile.lastIndexOf(File.separator)!=-1) shortfile = shortfile.substring(shortfile.lastIndexOf(File.separator)+1);
	   //System.out.println("filename: " + filename);
	   //System.out.println("shortfile: " + shortfile);
	   
	   if(!expFiles.contains(filename)) addExpFile(filename); //add it
	   //load it and select it
	   {
		   expMain = new ExpFile(new File(filename));
		   for(int i = 0; i < expSelector.getMenuComponentCount(); i++) {
			   JCheckBoxMenuItem currItem = (JCheckBoxMenuItem)expSelector.getItem(i);
			   if (currItem.getText().equals(shortfile)) {
				   //this is the right item
				   currItem.setSelected(true);
			   }
			   else currItem.setSelected(false);
		   }
	   }
   }
   ...
   public void addExpFile(String filename) {
      ...
      if (expFiles.contains(filename)) {
         ...
         expMain = new ExpFile(new File(filename));		//MC: expMain is the "open" expression file?  -yes, see comment above at expMain
      } else { //if file is not listed
         expMain = new ExpFile(new File(filename));
         if (expMain.isValid()) {
            ...
            //store everything in expfiletracker
            expFiles.insertElementAt(filename, 0);
            newExpFile.setName(filename);
            //add the item to the button group so only one can be checked at a time
            newExpFile.setSelected(true);
            //add an item listener to handle when the state of the item changes
            ...
            //add the menu to the expression menu(will not duplicate if run more than once)
            expMenu.add(expSelector, 0);
            if(expSelector.getItemCount()>=1) loadInfoChoice.setEnabled(true);
            else loadInfoChoice.setEnabled(false);
            if(expSelector.getItemCount()>=1) avgExpFileChoice.setEnabled(true);
            else avgExpFileChoice.setEnabled(false);
            if(expSelector.getItemCount()>=2) mergeChoice.setEnabled(true);
            else mergeChoice.setEnabled(false);
            if(expSelector.getItemCount()>=1) editExpChoice.setEnabled(true);
            else editExpChoice.setEnabled(false);
            if(expSelector.getItemCount()>=1) editExpInfoChoice.setEnabled(true);
            else editExpInfoChoice.setEnabled(false);
            //the following was added 6/26/2007 by Michael Gordon
            if(expSelector.getItemCount()>=1) replaceNamesWithAliasesChoice.setEnabled(true);
            else replaceNamesWithAliasesChoice.setEnabled(false);
            //the preceding was added 6/26/2007 by Michael Gordon 
            if(expSelector.getItemCount()>=1) exploreChoice.setEnabled(true);
            else exploreChoice.setEnabled(false);
            if(expSelector.getItemCount()>=1) manipChoice.setEnabled(true);
            else manipChoice.setEnabled(false);
            if(expSelector.getItemCount()>=1) disChoice.setEnabled(true);
            else disChoice.setEnabled(false);
   ...
   public void removeExpFile(String filename){
      ...
      if(select){
         if(expSelector.getItemCount()>1){
            ...
            editExpChoice.setEnabled(false);
            editExpInfoChoice.setEnabled(false);
            replaceNamesWithAliasesChoice.setEnabled(false);	//added 6/26/2007 by Michael Gordon
            exploreChoice.setEnabled(false);
            manipChoice.setEnabled(false);
            disChoice.setEnabled(false);
            mergeChoice.setEnabled(false);
      ...
      if(expSelector.getItemCount()<1) replaceNamesWithAliasesChoice.setEnabled(false);	//added 6/26/2007 by Michael Gordon
   ...
   //sets up the task manager and the task manager frame to be used throughout the open project
   ...
   public void switchExpFile(ItemEvent e) {
      if(e.getStateChange()==ItemEvent.SELECTED){
         ...
         }catch(Exception e2){expMain=null;}
   ...
   //opens a frame to edit an expression file
   private void editExpChoice_actionPerformed(ActionEvent e) {
      
      TableEditFrame tableEditExp = new TableEditFrame(expMain, openProject, true, false, true);
   ...
   //opens a frame to edit the information about genes in an expression file
   ...
   private void replaceNamesWithAliasesChoice_actionPerformed(ActionEvent e) {
	   ReplaceNamesWithAliasesDialog rnwad = new ReplaceNamesWithAliasesDialog(openProject, this, jdesktoppane);
	   rnwad.setModal(true);
	   Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
	   rnwad.pack();
	   rnwad.setResizable(false);
	   Dimension frameSize = rnwad.getSize();
	   ...
	   rnwad.setLocation((screenSize.width - frameSize.width)/2, (screenSize.height - frameSize.height)/2);
	   rnwad.setVisible(true);
	   rnwad.toFront();
	   
	   String file = rnwad.getValue();
	   if (file != null) {
		   //System.out.println("File is non-null");
		   //System.out.println("In fact, file is " + file);
		   ...
		   String old = rnwad.getExpFilePath();
		   ...
		   //System.out.println("Adding " + file + " to project");
		   openProject.addFile(file);
		   //System.out.println("Adding " + file + " to expFile");
		   this.addExpFile(file);
		   //System.out.println("Opening expFile " + file);
		   expMain = new ExpFile(new File(file));
	   }
//	   else {
...
//	   }
   ...
   //normalizes expression file data
   private void normChoice_actionPerformed(ActionEvent e) {
	   if (expMain.getColumns() > 2) {
		   ...
		   JOptionPane.showMessageDialog(this, "Error! You must have at least three columns to perform normalization.", "MAGIC Tool Error", JOptionPane.ERROR_MESSAGE);
	   }
   }
   
   //transforms expression file data
   private void transChoice_actionPerformed(ActionEvent e) {
      ...
      //We check that okay was clicked and that we did not abort because of bad values.
      if(transform.getOK()&&transform.getZeroResult()==0) writeExpFile(transform.getExpFile(),expMain.name+"_t"+transform.getTransform()+".exp",expMain.getName(), true);
   }
   
   //opens a frame to create a new dissimilarity file
   private void compDisChoice_actionPerformed(ActionEvent e) {
	  if(expMain.getColumns()<=2) {
		  //Warning case, we do not want to compute dissimilarities here.
		  JOptionPane.showMessageDialog(this, "Dissimilarities cannot be computed with 2 or fewer columns.\n" +
		  		"Please see documentation for more details.", "Warning", JOptionPane.WARNING_MESSAGE);
		  

	  }else{
	      DissimilarityFrame dissimframe1 = new DissimilarityFrame(expMain, openProject, this);
	      dissimframe1.setVisible(true);
	      dissimframe1.setLocation(180,100);		//TODO make the initial location of new windows dynamic
	      dissimframe1.pack();
   ...
   //opens a frame to create a new cluster file
   private void clusterChoice_actionPerformed(ActionEvent e) {
      ...
      clusterframe.setLocation(200,60); //MC:7/18/05 changed from (250,50)
      clusterframe.pack();
   ...
   //XXX make .cdt & .gtr file creation button here.
   ...
   //opens a frame to display a cluster file
   private void clustDisplayChoice_actionPerformed(ActionEvent e) {
      ...
      //clustdisplay.setLocation((screen.width-clustdisplay.getWidth())/2,(screen.height-clustdisplay.getHeight())/10); //XXX change inital frame location
   ...
   //opens a file loader to load an existing project file
   private void loadChoice_actionPerformed(ActionEvent e) {
      ...
      if(openProject==null||c==JOptionPane.YES_OPTION){
         System.gc();	//added 6/20/2007 by Michael Gordon
            ...
            Thread thread = new Thread(){
               public void run(){
                  ...
                  try{
                     ...
                     setTitle("MAGIC Tool, version " + MagicToolApp.versionString + " - " + fileobj.getPath());
                  ...
                  if(openProject!=null){
                     ...
                     //now we need to set the selected images and genelist to nothing at all.
                     redPath = null;
                     loadRed.setText("Red: <none>");
                     ...
                     segmentChoice.setEnabled(false);
                     gridChoice.setEnabled(false);
                     //and make it so that we can set red and green images
                     loadImagePair.setEnabled(true);
                     //set it so that we can't flag yet
                     flagChoice.setEnabled(false);
                  } else{
                     clustMenu.setEnabled(false);
                     expMenu.setEnabled(false);
   ...
   //creates a new project file at the user specified location
   private void newChoice_actionPerformed(ActionEvent e) {
      ...
      if(openProject==null||c==JOptionPane.YES_OPTION){
         ...
         if (result == JFileChooser.APPROVE_OPTION) {
            ...
            this.setTitle("MAGIC Tool, version "+ MagicToolApp.versionString +" - " + fileobj.getPath());
      ...
      if(openProject!=null){
         ...
         loadRed.setText("Red: <none>");
         loadRed.setState(false);
         loadRed.setEnabled(true);
         greenPath = null;
         loadGreen.setText("Green: <none>");
         loadGreen.setState(false);
         loadGreen.setEnabled(true);
         geneList = null;
         loadGeneListChoice.setEnabled(false);
         loadList.setText("<none>");
         loadList.setState(false);
   ...
   private void closeChoice_actionPerformed() {
      ...
      greenPath=null;
      geneListPath=null;
      redDim=new Dimension(0,0);
      greenDim=new Dimension(0,0);
      geneList=null;
      //
      if(openProject!=null){
         clustMenu.setEnabled(true);
    ...
    */
   public void addFile(File fileobj, boolean delete){	//TODO introduce methods for .raw & .gtr formats
      ...
      if(currFileName!=null){
         ...
         if(oldFileName.equals(currFileName)){
         ...
         } else if(!f.exists()||JOptionPane.OK_OPTION==(deleteFiles=JOptionPane.showConfirmDialog(this, "File" + f.getName()+ " Already Exists! Do You Wish To Overwrite That File?"
            ...
            try{
               ...
               if(delete) fileobj.delete(); //deletes the old file if desired
            }catch(Exception e2){
            ...
            openProject.addFile(currFileName); //adds the file to the project
            if(f.getName().toLowerCase().endsWith(".exp")) addExpFile(f.getPath());
         }
      } else{
         ...
         //The following extensions will not produce an error message when found in the project source directory.
         else if(fileobj.getName().toLowerCase().endsWith(".ds_store")){ message="";} else if(fileobj.getName().toLowerCase().endsWith(".txt")){ message="";} else if(fileobj.getName().toLowerCase().endsWith(".gif")){ message="";} else if(fileobj.getName().toLowerCase().endsWith(".jpeg")){ message="";} else if(fileobj.getName().toLowerCase().endsWith(".jpg")){ message="";} else if(fileobj.getName().toLowerCase().endsWith(".info")){ message="";} else if(fileobj.getName().toLowerCase().endsWith(".html")){ message="";} else if(fileobj.getName().toLowerCase().endsWith(".db")){ message="";} else if(fileobj.getName().toLowerCase().endsWith(".raw")){ message="";} else if(fileobj.getName().toLowerCase().endsWith(".cdt")){ message="";} else if(fileobj.getName().toLowerCase().endsWith(".gtr")){ message="";} else if(fileobj.getName().toLowerCase().endsWith(".jtv")){ message="";} else message+="File Extension Unknown. Please Check The File To Ensure It Has The Correct Extension";
   ...
   //adds a file to the open project
   ...
   public String setUpFile(File f){
      try{
         ...
         if(name.toLowerCase().endsWith(".exp")){
            ...
            SerialDiss serial = (SerialDiss)in.readObject();
            exp = serial.getExpFilePath();
            ...
            //XXX Added 5/28/2007 by Michael Gordon
         } else if (name.toLowerCase().endsWith(".flag")){
        	 return openProject.getPath()+"flags" + File.separator+name;
         } //end added 5/28/2007 by Michael Gordon
         else return null;
   ...
   //opens a frame to change the open project properties
   ...
   //adds a folder of files to the open project specified by the user
   ...
   //scans to ensure existance of all files in the open project and adds any files
   //which are in the project folder but are not in the proper location
   private void scanChoice_actionPerformed() {
	   scanChoice_actionPerformed(new File(openProject.getPath()));
   }
   
   //scans a folder and places files in their proper location
   ...
   //opens a dialog which allows a user to created a filtered expression file
   ...
   //writes an expression file to file from a filtered list of genes contained in the
   //group file temp
   ...
   //opens a dialog to merge two expression files together
         ...
         if(file!=null) {
            ...
            if(old!=null&&openProject.getGroupMethod()==0){
               ...
               for(int i=0; i<groupFiles.length; i++){
                  ...
                  }catch(DidNotFinishException e3){e3.printStackTrace();}
               }
            }
               ...
               for(int p=0; p<o.length; p++){
                  if(o[p]!=null && !((String)o[p]).trim().equals("")){
                     ...
                     if((loc=geneName.lastIndexOf("_rep"))!=-1){
                        if(openProject.getAverageReplicateMethod()==Project.NEVER_ADD_REPLICATES) gf.remove(o[p]);
                        else{
                           int count=1;
                           ...
                           for(int j=i+1; j<o.length; j++){
                              int oloc=-1;
                              if((o[j]!=null)&&(oloc=((String)o[j]).lastIndexOf("_rep"))!=-1){
                           ...
                           if(openProject.getAverageReplicateMethod()==Project.NEVER_ADD_REPLICATES);
                           else if(openProject.getAverageReplicateMethod()==Project.ANY_ADD_REPLICATES){
                              gf.addOne(shortname);
                           } else{
                              int expcount=0;
   ...
   //allows the user to scramble the data for a new expression file
   ...
   //allows the user to scramble the order of the genes for a new expression file
   private void scramOrder_actionPerformed(ActionEvent e) {
      scramble(ExpFile.SCRAMBLE_ORDER);
   }
   
   //allows the user to scramble the order of the data within genes for a new expression file
   private void scramGene_actionPerformed(ActionEvent e) {
      scramble(ExpFile.SCRAMBLE_WITHIN_GENE);
   }
   
   //allows the user to scramble the order of the data within the columns for a new expression file
   private void scramColumn_actionPerformed(ActionEvent e) {
      scramble(ExpFile.SCRAMBLE_WITHIN_COLUMN);
   }
   
   //allows the user to scramble all of the data in a new expression file
   ...
   private void dyeSwapDataChoice_actionPerformed(ActionEvent e) {
	   try{
		   DyeSwapFrame dsf = new DyeSwapFrame(expMain,openProject,this);
		   dsf.setModal(true);
		   dsf.pack();
		   dsf.setResizable(true);
		   Dimension screen = Toolkit.getDefaultToolkit().getScreenSize();
		   dsf.setLocation((screen.width-dsf.getWidth())/2,(screen.height-dsf.getHeight())/2);
		   dsf.setVisible(true);
		   dsf.toFront();
		   //System.out.println("dsf show success");
		   String file = dsf.getValue();
		   //System.out.println("dsf getValue success");
		   if(file!=null) {
			   System.out.println("File is not null!\nFile is: " + file);
			   String shortfile = new String(file);
			   if (shortfile.toLowerCase().endsWith(".exp")) shortfile = shortfile.substring(0,shortfile.toLowerCase().lastIndexOf(".exp"));
			   if (shortfile.lastIndexOf(File.separator) != -1) shortfile = shortfile.substring(shortfile.lastIndexOf(File.separator)+1);
			   //System.out.println("shortfile is " + shortfile);
			   String old = expMain.getName();
			   if (old.endsWith((".exp"))) old = old.substring(0,old.lastIndexOf(".exp"));
			   if (old.lastIndexOf(File.separator) != -1) old = old.substring(old.lastIndexOf(File.separator)+1);
   ...
   //opens a dialog to all a user to limit the columns of data from an expression file
   ...
   //shows the task manager frame
   private void taskmanChoice_actionPerformed(ActionEvent e) {
      tmFrame.show();
   }
   
   //shows a frame which allows a user to add a task to the task manager
   ...
   private void loadList_actionPerformed(ActionEvent e) {
      ...
      if (result == JFileChooser.APPROVE_OPTION) {
    	 setCursor((Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR)));	//added because the lack of cursorness was bugging me (Michael Gordon)
         File file = MainFrame.fileLoader.getSelectedFile();
   ...
   /*//The original code for the gridChoice menu.  Now, this is just a parent to 3 sub-menus.
    private void gridChoice_actionPerformed(ActionEvent e) {
      
      //If there is a valid project path, send it to the gridding frame for saving data
   ...
   */
   ...
   //Load a saved grid
   //Even though we will not be displaying the gridding frame, it is much safer to go ahead and initialize it
   //in case someone wants to bring it up afterwards
   private void loadSavedGrid_actionPerformed(ActionEvent e) {
	   System.out.println("Load a saved grid...");
	   
	   //no gridding frame has been created yet, so we need to make one.
	   //If one has already been created, then we can just proceed to the loadGrid subroutine
	   if(griddingFrame==null){
		     griddingFrame = new GriddingFrame(openProject, manager, redPath, greenPath, this);
	         ...
	         if(griddingFrame!=null){
	             loadImagePair.setEnabled(false);
	             segmentChoice.setEnabled(griddingFrame.canSegment());
	             flagChoice.setEnabled(griddingFrame.canSegment());	//MRG 1-10-2007
	             if(sf!=null&&sf.isVisible()) griddingFrame.setAllowChanges(false);
	        }
		     
	   }
       
       //calls new method that loads a grid from a file.  this method calls loadGrid(true)
       griddingFrame.newLoadGrid();
       
       //we need to enable the Segmentation menu, now that a grid file has been opened
       segmentChoice.setEnabled(griddingFrame.canSegment());
       //and the Flagging menu
       flagChoice.setEnabled(griddingFrame.canSegment());	//MRG 1-10-2007
   }
   
   //Create or edit a Metagrid
   private void createEditMetagrid_actionPerformed(ActionEvent e) {

			   System.out.println("Create or edit a metagrid...");
			   
			   //If there is a valid project path, send it to the gridding frame for saving data
			   
			   //there is no extant gridding frame, so create one, add it do the main pane, modify the menus (enabled etc)
			   if(metaGriddingFrame==null){
				   metaGriddingFrame = new MetaGriddingFrame(openProject, metaManager, redPath, greenPath, this);
				   
				   metaGriddingFrame.addInternalFrameListener(new InternalFrameAdapter(){
					   public void internalFrameClosed(InternalFrameEvent e){
			           
						   segmentChoice.setEnabled(metaGriddingFrame.canSegment());
			           
						   metaGriddingFrame = null;
						   loadImagePair.setEnabled(true);
					   }
			     });
				   jdesktoppane.add(metaGriddingFrame);
				   
				   metaGriddingFrame.pack();
				   metaGriddingFrame.setBounds(20,20, jdesktoppane.getWidth()-40, jdesktoppane.getHeight()-40);
				   metaGriddingFrame.fillScreen();
				   metaGriddingFrame.show();
				   metaGriddingFrame.toFront();
				   
				   metaGriddingFrame.finalMetaInit();
				   
				   //disable the regular grid editing
				   //createEditGrid.setEnabled(false);
			     
				   if(metaGriddingFrame!=null){
					   loadImagePair.setEnabled(false);
					   segmentChoice.setEnabled(metaGriddingFrame.canSegment());
					   if(sf!=null&&sf.isVisible()) metaGriddingFrame.setAllowChanges(false);
				   }
				   
			  } else {	//one already exists, so display it
				  metaGriddingFrame.show();
				  metaGriddingFrame.toFront();
			     try{
			    	 metaGriddingFrame.setIcon(false);
			     }catch(Exception e2){}
			     loadImagePair.setEnabled(false);
			     segmentChoice.setEnabled(metaGriddingFrame.canSegment());
			     flagChoice.setEnabled(metaGriddingFrame.canSegment());
			     if(sf!=null&&sf.isVisible()) metaGriddingFrame.setAllowChanges(false);
			  }
   ...
   //Create or edit a regular grid - this is essentially the older method of doing things, same code
   private void createEditGrid_actionPerformed(ActionEvent e) {
	   System.out.println("Create or edit a grid...");   
	   
       //If there is a valid project path, send it to the gridding frame for saving data
	   
	   //there is no extant gridding frame, so create one, add it do the main pane, modify the menus (enabled etc)
	   if(griddingFrame == null || !griddingFrame.isVisible()){
		   griddingFrame = new GriddingFrame(openProject, manager, redPath, greenPath, this);
		   griddingFrame.addInternalFrameListener(new InternalFrameAdapter(){
			   public void internalFrameClosed(InternalFrameEvent e){
	           
				   segmentChoice.setEnabled(griddingFrame.canSegment());
				   flagChoice.setEnabled(griddingFrame.canSegment()); //MRG 6-5-2007
		   ...
		   //disable the meta grid editing
		   //createEditMetagrid.setEnabled(false);
	  ...
	  flagChoice.setEnabled(griddingFrame.canSegment()); //MRG 5-28-2007
   }
   ...
   //added 1-10-2007 MRG
   private void flagChoice_actionPerformed(ActionEvent e){
	   flagman.checkForGridManagerChanges();
	   if(flagFrame==null){
		   flagFrame = new FlagFrame(openProject, manager, flagman, autoflagman, redPath, greenPath, this); //create the flagFrame
		   flagFrame.addInternalFrameListener(new InternalFrameAdapter(){//listen
			   public void internalFrameClosed(InternalFrameEvent e){//for it to be closed
				   flagFrame = null;//the frame should no longer exist
				   loadImagePair.setEnabled(true);//we can now load new red/greens
			   }
		   });
		   jdesktoppane.add(flagFrame); //put it out there
		   
		   flagFrame.pack();
		   flagFrame.setBounds(20,20, jdesktoppane.getWidth()-40, jdesktoppane.getHeight()-40);
	       flagFrame.fillScreen();
	       flagFrame.show();
	       flagFrame.toFront();
   ...
   private void segmentChoice_actionPerformed(ActionEvent e) {
      ...
      if (openProject!=null){         
         if(sf==null||!sf.isVisible()){
            segmentFrameCreationThread.run();
         } else{
            sf.toFront();
            try{
               sf.setIcon(false);
   ...
   public void spawnSegmentFrameAtSpot(final int grid, final int spot) {
	   boolean closed = (sf == null || !sf.isVisible()); 
	   if (closed) segmentFrameCreationThread.run();
	   Thread jumpToSpotThread = new Thread() {
		   public void run() {
			   sf.jumpToSpot(grid, spot);
		   }
	   };
	   try{
		   if (closed){
			   segmentFrameCreationThread.join();
		   }
		   jumpToSpotThread.run();
		   sf.toFront();
		   try {
			   sf.setIcon(false);
		   }
	   ...
	   //doClickOnChangeButtonThread.run();
	   sf.doClickOnChangeButton();
   }
   ...
   public void keyPressed(KeyEvent e) {
	   ...
	   if(keyCode == KeyEvent.VK_F1) helpChoice_actionPerformed(new ActionEvent(this, 0, "open window"));
   }
   ...
   public void destroyAndRecreateExploreFrame(String expFileName) {
	   DestroyAndRecreateExploreFrameThread processThread = new DestroyAndRecreateExploreFrameThread(expFileName);
	   processThread.run();
   }
   
   public void rescanProject(String currExpFileName) {
	   ScanThread processThread = new ScanThread(currExpFileName);
	   processThread.start();
   }
   
   private class DestroyAndRecreateExploreFrameThread extends Thread {
	   private String expFileName;
	   public DestroyAndRecreateExploreFrameThread(String expFN) {
		   expFileName = expFN;
	   }
	   public synchronized void run() {
		   exploreframe.dispose();
		   setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
		   scanChoice_actionPerformed();	//this refreshes the listing of the expression files available for operations
		   									//I thought it should re-scan every time but it doesn't. This alleviates all issues.
		   //set active expression file because doing scanChoice resets it - d'oh!
		   //expMain = new ExpFile(new File(expFileName));
		   loadExpFile(expFileName);
		   setCursor(Cursor.getDefaultCursor());
		   exploreChoice.doClick();
	   }
   }
   
   private class ScanThread extends Thread {
	   private String currExpFileName;
	   public ScanThread(String fn) {
		   this.currExpFileName = fn;
	   }
	   public void run() {
		   scanChoice_actionPerformed();
		   loadExpFile(currExpFileName);
	   }
   }
}

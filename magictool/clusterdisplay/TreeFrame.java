...
public class TreeFrame extends JInternalFrame implements KeyListener{
    ...
    private void jbInit () throws Exception {
      ...
      if(clustMethod == QTCLUST) tc = new QTClust();
      else if(clustMethod == KMEANS) tc = new KMeansClust();
      else tc = new HiClust();
  ...
  //used to form group of selected nodes
  ...
  private void expandAll (int row) {
    if (!((DefaultMutableTreeNode)(firsttree.getPathForRow(row)).getLastPathComponent()).isLeaf())
    try {

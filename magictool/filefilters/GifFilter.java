...
/**
 * GifFilter is a file filter used to select gif files in a file chooser
 */
public class GifFilter extends javax.swing.filechooser.FileFilter {

  /**Constucts the gif file filter*/
  public GifFilter(){}

  /**
   * returns whether or not file contains the gif file extension (.gif)
   * @param fileobj file to test
   * @return whether or not file contains the gif file extension (.gif)
   */

...
/**
 * ExpFilter is a file filter used to select expression files in a file chooser
 */
public class ExpFilter extends javax.swing.filechooser.FileFilter {

  /**Constucts the epxression file filter*/
  public ExpFilter(){}

  /**
   * returns whether or not file contains the expression file extension (.exp)
   * @param fileobj file to test
   * @return whether or not file contains the expression file extension (.exp)
   */

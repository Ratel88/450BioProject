 ...
 */
 public class FileMerger extends JDialog {
  ...
  public FileMerger(Project p, Frame parent) {
    ...
    filebox2 = new FileComboBox(p, Project.EXP,"all", true, "Expression");
  ...
  private void jbInit() throws Exception {
    ...
    jLabel5.setText("**The Nickname is composed of 5 or less characters used to identify " +
    "which");
  ...
  //sets the ok button to be enabled when both files have been chosen
  private void checkForOK(){
    if(filebox1.getSelectedIndex()!=0&&filebox2.getSelectedIndex()!=0
      &&!nick1.getText().trim().equals("")&&!nick2.getText().trim().equals("")){
  ...
  //sets the file for box1 and removes the file from box2 and enables ok button if possible
  ...
  //sets the file for box2 and removes the file from box1 and enables ok button if possible
  ...
  //limits the nickname to 5 characters
  ...
  //creates the new merged expression file

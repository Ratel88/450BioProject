...
public class CritDialog extends JDialog implements KeyListener{
    ...
    /*begin added 6/15/2007 by Michael Gordon*/
    private FlowLayout critAbsFlowLayout = new FlowLayout();
    private JComboBox critAbsComboBox1;
    private JComboBox critAbsComboBox2 = new JComboBox(tests);
    private JPanel critAbsPanel = new JPanel();
    private JLabel critAbsLabel = new JLabel();
    private JCheckBox critAbsCheckBox = new JCheckBox();
    private JTextField critAbsTextField = new JTextField();
    /*end added 6/15/2007 by Michael Gordon */
 ...
 */
  ...
  public void jbInit(){
    ...
    this.getContentPane().add(dialogContentPane);
        ...
        /*begin added 6/15/2007 by Michael Gordon*/
        //First, set up JTextField
        critAbsTextField.setPreferredSize(new Dimension(50, 21));
        critAbsTextField.setOpaque(false);
        critAbsTextField.setEnabled(false);
        //Next, ComboBox1
        critAbsComboBox1 = new JComboBox(expMain.getLabelArray());
        critAbsComboBox1.setEnabled(false);
        critAbsComboBox1.setMinimumSize(new Dimension(30, 24));
        critAbsComboBox1.setPreferredSize(new Dimension(100, 21));
        //ComboBox2
        critAbsComboBox2.setPreferredSize(new Dimension(50, 21));
        critAbsComboBox2.setMinimumSize(new Dimension(30, 21));
        critAbsComboBox2.setEnabled(false);
        //Label
        critAbsLabel.setText("Abs. val. in column labeled");
        critAbsLabel.setEnabled(false);
        //The FlowLayout
        critAbsFlowLayout.setAlignment(FlowLayout.LEFT);
        //make the JPanel use the FlowLayout
        critAbsPanel.setLayout(critAbsFlowLayout);
        //set up the checkbox actionlistener
        critAbsCheckBox.addActionListener(new java.awt.event.ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		critAbsCheckBox_actionPerformed(e);
        	}
        });
        //now put everything into the panel
        critAbsPanel.add(critAbsCheckBox);
        critAbsPanel.add(critAbsLabel);
        critAbsPanel.add(critAbsComboBox1,null);
        critAbsPanel.add(critAbsComboBox2);
        critAbsPanel.add(critAbsTextField,null);
        /*end added 6/15/2007 by Michael Gordon*/
        ...
        //setIconImage(Toolkit.getDefaultToolkit().createImage(dialogFrame.class.getResource("[Your Icon]")));
        ...
        dialogContentPane.add(critAbsPanel,null);	//added 6/15/2007 by Michael Gordon
      ...
      this.addKeyListenerRecursively(this);
        //this.setSize(new Dimension(481, 538));
        this.pack();
  ...
  public Criteria getCriteria(){
    ...
    if(critAbsCheckBox.isSelected()) criteria.setAbsVal(critAbsComboBox1.getSelectedIndex(), critAbsComboBox2.getSelectedIndex()==0, Double.parseDouble(critAbsTextField.getText()));
  ...
  public void setCriteria(Criteria criteria){
      try{
       ...
       if(((Boolean)criteria.value[0]).booleanValue()) setValue(((Integer)criteria.value[1]).intValue(),((Boolean)criteria.value[2]).booleanValue(), ((Boolean)criteria.value[3]).booleanValue(), ((Double)criteria.value[4]).doubleValue());
       else clearValue();
       if(((Boolean)criteria.column1[0]).booleanValue()) setColumnValue1(((Integer)criteria.column1[1]).intValue(),((Boolean)criteria.column1[2]).booleanValue(), ((Double)criteria.column1[3]).doubleValue());
       else clearColumnValue1();
       if(((Boolean)criteria.column2[0]).booleanValue()) setColumnValue2(((Integer)criteria.column2[1]).intValue(),((Boolean)criteria.column2[2]).booleanValue(), ((Double)criteria.column2[3]).doubleValue());
       else clearColumnValue2();
       if (((Boolean)criteria.absval[0]).booleanValue()) setAbsVal(((Integer)criteria.absval[1]).intValue(), ((Boolean)criteria.absval[2]).booleanValue(), ((Double)criteria.absval[3]).doubleValue());
       else clearAbsVal();
       if(((Boolean)criteria.comment[0]).booleanValue()) setComment(((Boolean)criteria.comment[1]).booleanValue(), criteria.comment[2].toString());
       else clearComment();
       if(((Boolean)criteria.alias[0]).booleanValue()) setGeneAlias(((Boolean)criteria.alias[1]).booleanValue(), criteria.alias[2].toString());
       else clearGeneAlias();
       if(((Boolean)criteria.name[0]).booleanValue()) setGeneName(((Boolean)criteria.name[1]).booleanValue(), criteria.name[2].toString());
       else clearGeneName();
       if(((Boolean)criteria.function[0]).booleanValue()) setMolecularFunction(((Boolean)criteria.function[1]).booleanValue(), criteria.function[2].toString());
       else clearMolecularFunction();
       if(((Boolean)criteria.std[0]).booleanValue()) setStdDev(((Boolean)criteria.std[1]).booleanValue(), ((Double)criteria.std[2]).doubleValue());
       else clearStdDev();
       if(((Boolean)criteria.chromosome[0]).booleanValue()) setChromosome(((Integer)criteria.chromosome[1]).intValue());
       else clearChromosome();
       if(((Boolean)criteria.bio[0]).booleanValue()) setBioProcess(((Boolean)criteria.bio[1]).booleanValue(), criteria.bio[2].toString());
       else clearBioProcess();
       if(((Boolean)criteria.cell[0]).booleanValue()) setCellComment(((Boolean)criteria.cell[1]).booleanValue(), criteria.cell[2].toString());
       else clearCellComment();
  ...
  /**
   * changes the settings for the absolute value column criteria
   * @param column column number
   * @param greater whether or not we're looking for values greater than number or not
   * @param number criteria value
   */
  public void setAbsVal(int column, boolean greater, double number) {
	  critAbsCheckBox.setSelected(true);
	  critAbsComboBox1.setSelectedIndex(column);
	  critAbsComboBox2.setSelectedIndex(greater?0:1);
	  critAbsTextField.setText(String.valueOf(number));
	  critAbsComboBox1.setEnabled(true);
	  critAbsComboBox2.setEnabled(true);
	  critAbsTextField.setEnabled(true);
	  critAbsLabel.setEnabled(true);
  }
  
  /**
   * clears the settings for the column absolute value criteria
   */
  public void clearAbsVal(){
	  critAbsCheckBox.setSelected(false);
	  critAbsComboBox1.setSelectedIndex(0);
	  critAbsComboBox2.setSelectedIndex(0);
	  critAbsTextField.setText("");
	  critAbsComboBox1.setEnabled(false);
	  critAbsComboBox2.setEnabled(false);
	  critAbsTextField.setEnabled(false);
	  critAbsLabel.setEnabled(false);
      ...
      public void run(){
        ...
        try{
              if (crit1CheckBox.isSelected()) {
                  ...
                  if (crit1ComboBox2.getSelectedItem() == "value") {
                      ...
                      for (int row = 0; row <= expMain.numGenes() - 1; row++) {
                          ...
                          if (((crit1ComboBox1.getSelectedItem() == "Min.") &&
                                  (crit1ComboBox3.getSelectedItem() == "<") &&
                                  (min < limit)) || ((crit1ComboBox1.getSelectedItem()
                                  == "Min.") && (crit1ComboBox3.getSelectedItem()
                                  == ">") && (min > limit)) || ((crit1ComboBox1.getSelectedItem()
                                  == "Max.") && (crit1ComboBox3.getSelectedItem()
                                  == "<") && (max < limit)) || ((crit1ComboBox1.getSelectedItem()
                                  == "Max.") && (crit1ComboBox3.getSelectedItem()
                                  == ">") && (max > limit)) || ((crit1ComboBox1.getSelectedItem()
                                  == "Avg.") && (crit1ComboBox3.getSelectedItem()
                                  == "<") && (avg < limit)) || ((crit1ComboBox1.getSelectedItem()
                                  == "Avg.") && (crit1ComboBox3.getSelectedItem()
                                  == ">") && (avg > limit)))
                              crit1treeset.add(expMain.getGeneName(row));
                      }
                  }
                  ...
                  if (booComboBox.getSelectedItem() == "any")
                      grpMain.meetAny(crit1treeset);
                  if (booComboBox.getSelectedItem() == "all")
                      grpMain.meetAll(crit1treeset);
          ...
          if (crit2CheckBox.isSelected()) {
              ...
              for (int row = 0; row <= expMain.numGenes() - 1; row++) {
                  if (((crit2ComboBox2.getSelectedItem() == "<") && (expMain.getDataPoint(row,
                          column) < limit)) || ((crit2ComboBox2.getSelectedItem()
                          == ">") && (expMain.getDataPoint(row, column) > limit)))
                      crit2treeset.add(expMain.getGeneName(row));
              }
              if (booComboBox.getSelectedItem() == "any")
                  grpMain.meetAny(crit2treeset);
              if (booComboBox.getSelectedItem() == "all")
                  grpMain.meetAll(crit2treeset);
          ...
          if (crit3CheckBox.isSelected()) {
              ...
              for (int row = 0; row <= expMain.numGenes() - 1; row++) {
                  if (((crit3ComboBox2.getSelectedItem() == "<") && (expMain.getDataPoint(row,
                          column) < limit)) || ((crit3ComboBox2.getSelectedItem()
                          == ">") && (expMain.getDataPoint(row, column) > limit)))
                      crit3treeset.add(expMain.getGeneName(row));
              }
              if (booComboBox.getSelectedItem() == "any")
                  grpMain.meetAny(crit3treeset);
              if (booComboBox.getSelectedItem() == "all")
                  grpMain.meetAll(crit3treeset);

          }
          /*begin added 6/15/2007 by Michael Gordon*/
          if (critAbsCheckBox.isSelected()) {
        	  
        	  TreeSet critAbsTreeSet = new TreeSet();
        	  int column = expMain.getLabelNum(critAbsComboBox1.getSelectedItem());
        	  double limit = Double.parseDouble(critAbsTextField.getText());
        	  for (int row = 0; row < expMain.numGenes(); row++) {
        		  if ((((critAbsComboBox2.getSelectedItem()) == "<") && (Math.abs(expMain.getDataPoint(row, column)) < limit)) || ((critAbsComboBox2.getSelectedItem() == ">") && (Math.abs(expMain.getDataPoint(row,column)) < limit))) {
        			  critAbsTreeSet.add(expMain.getGeneName(row));
        		  }
        	  }
        	  if (booComboBox.getSelectedItem() == "any") grpMain.meetAny(critAbsTreeSet);
        	  if (booComboBox.getSelectedItem() == "all") grpMain.meetAll(critAbsTreeSet);
          }
          /*end added 6/15/2007 by Michael Gordon*/
          if (crit4CheckBox.isSelected()) {
              ...
              for (int row = 0; row <= expMain.numGenes() - 1; row++) {
                  ...
                  if (((crit4ComboBox.getSelectedItem() == "<") && (stddev < limit))
                          || ((crit4ComboBox.getSelectedItem() == ">") &&
                          (stddev > limit)))
                      crit4treeset.add(expMain.getGeneName(row));
              }
              if (booComboBox.getSelectedItem() == "any")
                  grpMain.meetAny(crit4treeset);
              if (booComboBox.getSelectedItem() == "all")
                  grpMain.meetAll(crit4treeset);
          ...
          if (crit5CheckBox.isSelected()) {
              ...
              if (booComboBox.getSelectedItem() == "any")
                  grpMain.meetAny(crit5treeset);
              if (booComboBox.getSelectedItem() == "all")
                  grpMain.meetAll(crit5treeset);
          ...
          if (crit6CheckBox.isSelected()) {
              ...
              if (booComboBox.getSelectedItem() == "any")
                  grpMain.meetAny(crit6treeset);
              if (booComboBox.getSelectedItem() == "all")
                  grpMain.meetAll(crit6treeset);
          ...
          if (crit7CheckBox.isSelected()) {
              ...
              if (booComboBox.getSelectedItem() == "any")
                  grpMain.meetAny(crit7treeset);
              if (booComboBox.getSelectedItem() == "all")
                  grpMain.meetAll(crit7treeset);
          ...
          if (crit8CheckBox.isSelected()) {
              ...
              if (booComboBox.getSelectedItem() == "any")
                  grpMain.meetAny(crit8treeset);
              if (booComboBox.getSelectedItem() == "all")
                  grpMain.meetAll(crit8treeset);
          ...
          if (crit9CheckBox.isSelected()) {
              ...
              if (booComboBox.getSelectedItem() == "any")
                  grpMain.meetAny(crit9treeset);
              if (booComboBox.getSelectedItem() == "all")
                  grpMain.meetAll(crit9treeset);
          ...
          if (crit10CheckBox.isSelected()) {
              ...
              if (booComboBox.getSelectedItem() == "any")
                  grpMain.meetAny(crit10treeset);
              if (booComboBox.getSelectedItem() == "all")
                  grpMain.meetAll(crit10treeset);
          ...
          if (crit11CheckBox.isSelected()) {
              ...
              if (booComboBox.getSelectedItem() == "any")
                  grpMain.meetAny(crit11treeset);
              if (booComboBox.getSelectedItem() == "all")
                  grpMain.meetAll(crit11treeset);

          }


          if (crit1CheckBox.isSelected() || crit2CheckBox.isSelected() || crit3CheckBox.isSelected() || critAbsCheckBox.isSelected()
              || crit4CheckBox.isSelected() || crit5CheckBox.isSelected() || crit6CheckBox.isSelected()
              || crit7CheckBox.isSelected() || crit8CheckBox.isSelected() || crit9CheckBox.isSelected()
              || crit10CheckBox.isSelected() || crit11CheckBox.isSelected()) {

                      grpMain.setTitle("Temporary Group");
                      //expMain.setName("Temporary Group"); //Sets the expressions name.
                      dispose();
  ...
  public GrpFile getValue(){
    return grpMain;
     ...
     //Start of critDialog button actions
    //Toggles various options when the checkbox is clicked
  ...
  private void crit2CheckBox_actionPerformed (ActionEvent e) {
   ...
   private void critAbsCheckBox_actionPerformed(ActionEvent e) {
	   if (critAbsCheckBox.isSelected()) {
		   critAbsLabel.setEnabled(true);
		   critAbsComboBox2.setEnabled(true);
		   critAbsComboBox1.setEnabled(true);
	   ...
	   else { //critAbsCheckBox is not selected
		   critAbsLabel.setEnabled(false);
		   critAbsComboBox2.setEnabled(false);
		   critAbsComboBox1.setEnabled(false);
		   critAbsTextField.setEnabled(false);
  ...
  protected class Criteria {
    ...
    /**holds the settings for the absolute value criteria*/
    protected Object[] absval;
   ...
   * changes the settings for the absolute value column criteria
   * @param column column number
   * @param less whether or not we're looking for a value less than the given value
   * @param number criteria value
   */
  public void setAbsVal(int column, boolean less, double number) {
	  absval[0] = new Boolean(true);
	  absval[1] = new Integer(column);
	  absval[2] = new Boolean(less);
	  absval[3] = new Double(number);
  }

  /** 
   * clears the settings for the absolute value column criteria
   */
  public void clearAbsVal() {
	  absval[0] = new Boolean(false);
	  absval[1] = new Integer(0);
	  absval[2] = new Boolean(false);
	  absval[3] = new Double(Double.NaN);
  }

...
class GridPanel extends JPanel {
  ...
  protected JTextField rowNum = new JTextField();
  private JPanel jPanel6 = new JPanel();
  private JPanel jPanel9 = new JPanel();
  private JLabel columnNumLabel = new JLabel();
  protected JTextField columnNum = new JTextField();
  ...
  //private double m1, m2, normalPtX, normalPtY;
  //private int gridNum;
  ...
  private void jbInit() throws Exception {
    ...
    this.add(new RotateButtonPanel());
  ...
  public void updateGrids(){
      try{
        ...
        catch(Exception e){JOptionPane.showMessageDialog(iDisplay,"Error Updating! Please Enter Integers In All Text Fields");}

  }

  /**
   * Updates the grids based on the user move the grids around.
   */
  public void updateGridsMouse(){
      try{
       if (rowNum.getText() != null) {
            rows = Integer.parseInt(rowNum.getText().trim());
            grid.setRows(rows);
  ...
  protected void updateApplyFromBox(){
    ...
    for(int i=0; i<iDisplay.manager.numGrids; i++){
      if(iDisplay.manager.getGrid(i).isValid()&&iDisplay.manager.getGrid(i)!=grid){
        ...
        n++;
        //if(orig==i) pos=i;
        //set it to the lowest valid index.
        if(orig==-1) orig=i;
      }
    }
    ...
    //Error checking in bizarre case when clearing a grid (grid 2?) and returning to 1. With new implemenation may not be needed.
    if(pos>=applyFrom.getItemCount()) {
    	pos = 0;
    }
  ...
  protected class RotateButtonPanel extends JPanel {
	  ...
	  public RotateButtonPanel(){
		...
		counterclockwiseButton.addActionListener(new java.awt.event.ActionListener() {
	        public void actionPerformed(ActionEvent e) {
	        	GriddingFrame.gma.rotateCounterclockwise();
	        }
	      });
		
		clockwiseButton.addActionListener(new java.awt.event.ActionListener() {
	        public void actionPerformed(ActionEvent e) {
	        	GriddingFrame.gma.rotateClockwise();
	        }
	      });

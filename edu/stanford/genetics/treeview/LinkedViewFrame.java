...
public class LinkedViewFrame extends TreeViewFrame implements Observer
{
	...
	protected void populateSettingsMenu2(Menu settingsMenu)  {
				MenuItem presetItem = new MenuItem("Gene Url Presets...", new MenuShortcut(KeyEvent.VK_P));
				presetItem.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent actionEvent) {
						if (presetsPanel == null) setupPresetsPanel();
				...
				MenuItem kcolorItem = new MenuItem("Karyoscope Color Presets...");
				kcolorItem.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent actionEvent) {
						if (presetsPanel == null) setupPresetsPanel();
						presetsPanel.synchronizeFrom();
						presetsPanel.setSelectedIndex(4);
						presetsFrame.show();
					}
				});
				MenuItem coordsItem = new MenuItem("Karyoscope Coordinates...");
				coordsItem.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent actionEvent) {
						if (presetsPanel == null) setupPresetsPanel();
						presetsPanel.synchronizeFrom();
						presetsPanel.setSelectedIndex(5);
						presetsFrame.show();
					}
				});
				
				settingsMenu.add(kcolorItem);

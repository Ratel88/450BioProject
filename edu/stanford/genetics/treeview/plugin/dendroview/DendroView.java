 ...
 * @version $Revision: 1.1 $ $Date: 2007/06/01 14:33:19 $
 */
	...
	*/
	...
	public void alignAtrToModel(AtrTVModel model)
	{
		try{
			...
			((TVModel)getDataModel()).saveOrder(ordering);
			((Observable)getDataModel()).notifyObservers();
...
/*
	...
	itemg.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent actionEvent)
		{
			  	if (settingsPanel == null) setupSettingsPanel();
...
/*
	MenuItem itema = new MenuItem("Array Settings...");
...
*/
	...
	urlItem.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent actionEvent) {
			...
			settingsFrame.addWindowListener(XmlConfig.getStoreOnWindowClose(getDataModel().getDocumentConfig()));
			settingsFrame.pack();

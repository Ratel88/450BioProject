...
public class TreeViewFrame extends ViewFrame {
	...
	/**
	 * Magic Tool will send in the appropriate file name and file set. Then that project will be 
	 * displayed to the screen.
	 */
	public void setProject(FileSet fileSet){
		try{
			loadFileSet(fileSet);
			fileSet = fileMru.addUnique(fileSet);
			fileMru.setLast(fileSet);
			...
			JOptionPane.showMessageDialog(this, "Error Leading the Recently Created File.", "Error",

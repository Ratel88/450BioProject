...
public class XMLWriter
{
      ...
      throws IOException
   {
      ...
      if (xml.getName() == null) {
         ...
         Enumeration e2 = xml.enumerateAttributeNames();
         ...
         while (e2.hasMoreElements()) {
          ...
          e2 = xml.enumerateAttributeNames();
         ...
         if ((xml.getContent() != null)
            ...
            e2 = xml.enumerateChildren();

            while (e2.hasMoreElements()) {
               IXMLElement child = (IXMLElement) e2.nextElement();
